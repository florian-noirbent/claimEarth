...
`CompiledTerrainData` is the hot-loop lookup table produced from the registry. It maps stable terrain IDs to compact motion, collision, passability, visual, and transfer values so simulation, rendering, collision, and dirtying do not chase live resources.
